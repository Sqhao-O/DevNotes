...
返回 [Java SE 学习索引](00_JavaSE学习索引.md)。

## 1. Math

- 常用方法

![](assets/10_javaAPI_1/Math.png)
...
![](assets/10_javaAPI_1/System.png)
...
![](assets/10_javaAPI_1/Runtime.png)
...
> ![](assets/10_javaAPI_1/浅克隆.png) > > + 深克隆会新建一个该引用数据类型变量，将源对象的该成员变量的数值复制过去 >
> ![](assets/10_javaAPI_1/深克隆.png)
...
![](assets/10_javaAPI_1/bigInteger的底层原理.png)
...
![](assets/10_javaAPI_1/BigDecimal方法.png)

- 存储方式

  把数据看成字符串，遍历得到里面的每一个字符，把这些字符在ASCII码表上的值，都存储到数组中。

![](assets/10_javaAPI_1/bigDecimal的底层原理.png)
