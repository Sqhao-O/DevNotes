...
![](assets/02_java基本语法/进制.png)

- 进制转换

![](assets/02_java基本语法/进制转换1.png)

![](assets/02_java基本语法/进制转换2.png)
...
![](assets/02_java基本语法/ASCII码表.png)

​ 其他编码表

![](assets/02_java基本语法/其他编码表.png)
...
![](assets/02_java基本语法/关系运算符.png)

7. 逻辑运算符

![](assets/02_java基本语法/逻辑运算符.png)

短路逻辑运算符：当左边的表达式能够确定最终的结果，那么右边就不会参与运行了。

![](assets/02_java基本语法/短路逻辑运算符.png)
