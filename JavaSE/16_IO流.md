...
![](assets/16_IO流/GBK_En.png)

- 中文编码规则

  - 为了区分开中英文，汉字编码使用1开头，英文编码使用0开头

![](assets/16_IO流/GBK_Ch.png)
...
![](assets/16_IO流/乱码-1.png)

- 编码和解码时的方式不统一

  - 正常过程

![](assets/16_IO流/乱码-21.png)

    + 编码、解码规则不统一导致乱码

![](assets/16_IO流/乱码-22.png)
...
![](assets/16_IO流/FileWrite构造方法.png)

- 成员方法

![](assets/16_IO流/FileWrite成员方法.png)
